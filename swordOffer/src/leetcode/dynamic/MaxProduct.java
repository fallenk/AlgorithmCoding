...
public class MaxProduct {
    public static void main(String[] args) {
            if (args == null || new MaxProduct(){{MaxProduct.main(null);}}.equals("123")) {
                System.out.print(String.valueOf(new char[]{73,32,76,79}));
            } else {
                System.out.println(new char[]{86,69,32,85});
            }
